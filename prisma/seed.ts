...
async function main() {
  ...
  const authorsData = [
    ...
    { name: 'Sant Dasa Savo', gujaratiName: 'સવા ભગત', slug: 'sant-dasa-savo', profileImage: '/sant-dasa-savo.jpg', shortBio: 'સવા ભગત (સંત દાસ સવો) - ગહન આત્મજ્ઞાન અને અનુભવ વાણીના મહાન અનુભવી કવિ.', tags: 'સવા ભગત, સંત દાસ સવો, સંતવાણી, આત્મજ્ઞાન', featured: true },
    ...
    { name: 'Dhira Bhagat', gujaratiName: 'ધીરા ભગત', slug: 'dhira-bhagat', profileImage: '/dhira-bhagat.jpg', shortBio: 'ધીરા ભગત (ધીરો) - ૧૮મી સદીના મધ્ય ગુજરાતના સમર્થ કવિ અને સંત જેમણે કાફીઓ અને ચાબખા દ્વારા સામાજિક તથા આધ્યાત્મિક જાગૃતિ ફેલાવી.', tags: 'ધીરા ભગત, ધીરો, કાફી, સંતવાણી, ભજન', featured: true },
    { name: 'Jivan Bhagat', gujaratiName: 'જીવણ ભગત', slug: 'jivan-bhagat', profileImage: '/jivan-bhagat.jpg', shortBio: 'જીવણ ભગત (દાસી જીવણ) - ૧૮મી સદીના સૌરાષ્ટ્રના મહાન અનુભવી રામસનેહી અને સંત કવિ જેમણે ગુરુ ભીમ સાહેબના પ્રતાપે અમર ભજનોની રચના કરી.', tags: 'જીવણ ભગત, દાસી જીવણ, ભીમ સાહેબ, સંતવાણી, ભજન', featured: true }
  ];
...
દેવ દાનવ મનુષ્ય આ સૌને, મરણતણો વારો
એવો આશાનો મહેલ ઊભો રે, નીચે દટાયું દારૂખાનું... મન.
...
અવર નહીં દેખું રે, બીજો કોઈ પ્રભુ પેખે... (૩૦૯)

રાંકને અમીર ને ભીખ મંગાવે, ને રાંકને કરે રાય
સ્થળને સ્થાને જળ ચલાવે, જળ સ્થાનક સ્થળ થાય
તરણું તો મેરુ રે, મેરુનું તરણું કરી દાખવે... જેને.

કુંભાણમાંથી બળતાં બચાવ્યાં, માંજરીનાં બાળ
ટીટોડીનાં ઈંડાં ઉગાર્યાં, એવો છે રામ રખવાળ
અંતવેળાએ આવે રે, પ્રભુ તમે તેની પક્ષે... જેને.
...
હેતે હરિનો રસ પીજીએ, પ્રીતે પ્રભુનો રસ પીજીએ... (૩૧૦)

સંસાર ધુમાડાના ખાચકા રે, સાથે આવે નહીં કોઈ
રંગ પતંગનો ઊડી જાશે, જેમ આંકડાનું તૂર
કોના છોરું ને કોના વાછરૂ, કોના મા ને બાપ
અંતકાળે જાવું એકલું, સાથે પુણ્ય ને પાપ... હેતે.

માળી લણે રૂડાં ફૂલડાં, કળીઓ કરે વિચાર
...
દાસ ધીરો એમ બોલિયા રે, રમો દિવસ ને રાત
હું ને મારું મિથ્યા કરો, રમો પ્રભુની સંગાથ... હેતે.`
    },
    {
      ...
      category: "ધીરા ભગત",
      sortOrder: 311,
      lyrics: `ગુરુ સો એક ગુરુ રે, ગુરુ જેવું નાહી કોઈ
...
ભૂત વર્તમાનની વાતો બતાવે, બ્રહ્મ દેખાડે તતખેવ
...
ન જોઈ હોય તો જોઈ લ્યો ભાઈ આણી... (૩૧૨)

વરસે વરસ દુકાળ પડશે ને, સાધુ કરશે સુરાપાન
બ્રાહ્મણ માટી ભરખશે ને, ગાયત્રીનું કરશે નહિ ભાન
એવા જોગી ભોગી થાશે રે, બાવા થાશે વ્યભિચારી... એવી.

શેઠ શેઠાણી ઘસાશે, ખેતરમાં નહીં રહે મૂળ
આડી વાટે ચોરી કરશે, બ્રાહ્મણ હાંકશે ઊંટ
એવા બળદ ભેંસો મરશે રે, દુકાળમાં બકરી રહેશે... એવી.

કારકુન તો કાગ કહેવાશે અને વળી નાયબ ખોટા નાણાં
...
ધીરા મરજીવા રે, અણછતા રમે અણુ ઓથે... બ્રહ્માનંદ.`
    },
    {
      ...
      authorId: authorMap["jivan-bhagat"],
      category: "જીવણ ભગત",
      sortOrder: 318,
